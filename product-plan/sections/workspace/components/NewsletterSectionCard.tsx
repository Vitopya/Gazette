  ...
  return (
    <section className="group/section">
      <header className="flex items-center gap-2 mb-3 pb-2 border-b border-zinc-200 dark:border-zinc-800">
        <button
          type="button"
          className="cursor-grab text-zinc-300 hover:text-zinc-500 dark:text-zinc-700 dark:hover:text-zinc-400 transition-colors opacity-0 group-hover/section:opacity-100"
